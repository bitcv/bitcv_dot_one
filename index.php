...
<div id="app">
    ...
    <section class="section" id="foundation">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center">{{ foundation.name[lang] }}</h2>
                    <p class="">{{ foundation.intro.p1[lang] }}</p>
                    <p class="">{{ foundation.intro.p2[lang] }}</p>
                    <p class="">{{ foundation.intro.p3[lang] }}</p>
                    <p class="">{{ foundation.intro.p4[lang] }}</p>
                    <p class="">{{ foundation.intro.p5[lang] }}</p>
                    <p class="">{{ foundation.intro.p6[lang] }}</p>
                    <div class="text-center">
                        <img src="./img/foundation-qrcode.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="./js/data.js?v=20191008"></script>
