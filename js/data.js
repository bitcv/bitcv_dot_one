    ...
    data: {
        ...
        foundation: {
            ...
            intro: {
                ...
                p4: { cn: '在BCV和BAC的運營中，也獲得了大量用戶和社群的支持，自抵押和銷毀BCV預挖礦BAC以來，已有60個BAC生態節點參與挖礦，共計抵押和銷毀1.7億BCV以上，基於BAC打造的社區化交易所也即將上線運營，為BCV生態的社群和BAC的價值支撐打下重要基礎。', en: "In the operation of BCV and BAC, a large number of users and communities have also been supported. Since the mortgage and destruction of BCV pre-mining BAC, 60 BAC ecological nodes have participated in mining. A total of more than 170 million BCV have been mortgaged and destroyed. The community exchange based on BAC will soon be put into operation to support the value of BCV ecological community and BAC. Lay an important foundation.", jp: 'BVCとBACの運営においても、多くのユーザーとコミュニティ群の支持を得ており、BCV のプレ採掘BACを担保と廃棄して以来、60 BACの生態ノードが鉱山を掘ることに参加し、合計で担保と廃棄1.7億BCV 以上、BACに基づくコミュニティ化取引所もオンラインで運営しており、BVC生態のコミュニティ群とBACの価値を支えています。重要な基礎を築く。', ko: 'BCV 와 BAC 의 운영 중에서도 대량의 사용자와 단체의 지지를 받고, 저당 및 BCV 를 소각하는 BACV를 훼손한 이후 이미 60개 BAC 의 생태 노드가 채굴되어 1억7억BCV 를 소각해 1억7억BCV 이상, BAC 가 만든 커뮤니케이션 거래소에서도 상위권을 운영하고, BCV 의 생태적 지탱과 BAC 의 가치 지탱중요한 기초를 닦다.' },
