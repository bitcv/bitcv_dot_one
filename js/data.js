/**
 * note
 * iconfont website: https://themify.me/themify-icons
 */
var app = new Vue({
    ...
    data: {
        ...
        foundation: {
            name: { cn: 'BCV基金會', en: 'BCV Foundation', jp: 'BCV 基金', ko: 'BCV 기금회' },
            intro: {
                p1: { cn: 'BCV成立於新加坡，是數位資產管理領域的區塊鏈項目。', en: 'BCV, founded in Singapore, is a block chain project in the field of digital asset management.', jp: 'BCVはシンガポールに設立され、デジタル資産管理分野のブロックチェーンプロジェクトです。', ko: 'BCV 가 싱가포르에 설립된 것은 디지털 자산 관리 분야의 구별 체인 항목이다.' },
                p2: { cn: 'BCV與全球眾多戰略夥伴建立合作，並通過幣威技術支援，開發了數位資產生態相關產品，讓數位資產管理服務得以落地。經過一年多的發展，產品獲得了用戶的喜愛，建立了相當的影響力和關注。', en: "BCV has established cooperation with many strategic partners around the world, and through the technical support of Moneyway, developed digital assets eco-related products, so that digital assets management services can be landed. After more than a year of development, the product has won the user's favor and established considerable influence and attention.", jp: 'BCV は世界の多くの戦略パートナーと提携し、貨幣威技術のサポートを通じて、デジタル資産の生態関連製品を開発し、デジタル資産管理サービスを着地させました。一年余りの発展を経て、製品はユーザーの好感を得て、相当な影響力と関心を創立しました。', ko: 'BCV 는 글로벌 전략 동반자와 합작을 맺고, 화폐 기술 지원을 통해 디지털 자산 생태 관련 제품을 개발해 디지털 자산 관리 서비스를 낙지시켰다.1년 넘게 발전해 제품은 사용자의 사랑을 받아 상당한 영향력과 관심을 모았다.' },
                p3: { cn: '在一年多的發展中，BCV已成為區塊鏈領域知名項目，市值排名即將進入全球百强，同時在火幣、HCoin、AEX等知名平臺進行交易，讓BCV獲得了廣大用戶和投資者的關注。構建BCV生態社群合作，提供數億枚BCV激勵BCV生態推廣者，以創新的基金化運營，專業的管理，為BCV發展社群，構建全球影響力，在資本領域的發展和社群的壯大作出貢獻。', en: "In more than a year's development, BCV has become a well-known project in the area of block chain. Its market value ranking is about to enter the top 100 in the world. At the same time, it trades on Huobi, HCoin, AEX and other well-known platforms, which has attracted the attention of users and investors. Construct BCV ecological community cooperation, provide hundreds of millions of BCV to motivate BCV ecological promoters, with innovative fund operation, professional management, for the development of BCV community, build global influence, and contribute to the development and growth of the community in the field of capital.", jp: '一年余りの発展の中で、BCV はブロックチェーン分野で有名なプロジェクトとなりました。市場価値ランキングはもうすぐ世界トップ100に入ります。同時にHubbi、HCoil、AEXなどの有名なプラットフォームで取引して、BCV に広大なユーザーと投資家の注目を得させました。BCV 生態社会群協力を構築し、BCV 数億枚のBCV がBCV 生態普及者を激励し、革新的な基金化運営、専門的な管理を提供し、BCV 発展社会群のために、世界的な影響力を構築し、資本分野の発展と社会群の強大化に貢献します。', ko: '1년 넘게 발전한 가운데, BCV 는 블록 체인 분야에서 유명 프로젝트가 되고, 시가가 글로벌 백강에 진입할 예정이며, Huobi, HCoin, AEX 등 유명 플랫폼에서 거래를 진행하며, BCV 가 많은 사용자와 투자자들의 관심을 얻고 있다.BCV 생태단체를 구축하고, BCV 의 생태보급자를 수억억여 건의 BCV 의 생태보급자를 격려하고 혁신적인 펀드화 운영으로, 전문적인 관리를 위해 BCV 를 발전시켜 글로벌 영향력을 구축하고, 자본 분야의 발전과 집단의 장대공헌에 기여했다.' },
                p4: { cn: '幣威鏈的在BCV和BAC的雙幣雙通縮經濟系統，也獲得了大量用戶和社群的支持，自幣威鍊主網預挖礦活動啟動以來，已有超過60個BAC生態節點參與挖礦，共計抵押和銷毀超過2億枚BCV，基於BAC為平台幣打造的社區化交易所也即將上線運營，幣威鍊主網上線後，BAC將成為公鏈幣和平台幣的雙屬性通證，為BCV生態的社群和BAC的價值支撐打下重要基礎。', en: "The dual-token and dual-deflation economic system of BCV and BAC has been supported by a large number of users and communities. Since the start of the pre-mining event of the Bit Asset Chain, more than 60 BAC ecological nodes have been involved in the mining and a total of more than 200 million BCV has been mortgaged and destroyed. The community exchange based on BAC will soon be put into operation. After that, BAC will become the dual-purpose token of the public chain and community exchange to support the value of BCV ecological community and BAC system.", jp: "BCVとBACの二重通貨二重契約経済システムも多数のユーザーとコミュニティによってサポートされています。通貨チェーンのメインチェーンの事前採掘活動の開始以来、60以上のBACエコロジカルノードが掘削に関与しています。 鉱山、合計2億BCVの住宅ローンの破壊、コミュニティベースの交換を作成するプラットフォーム通貨のBACに基づいて、通貨チェーンのメインラインの後、BACは公通貨と民間通貨の二重ライセンスになります。 BCVエコロジーのコミュニティサポートとBACの価値の重要な基盤を築きます。", ko: "BCV 및 BAC의 이중 통화 이중 계약 경제 시스템도 많은 사용자와 커뮤니티의 지원을 받았으며, 통화 체인의 메인 체인의 사전 마이닝 활동이 시작된 이후 60 개 이상의 BAC 생태 노드가 파기에 관여했습니다. 커뮤니티 기반의 거래소를 만들기위한 플랫폼 통화에 대한 BAC를 기반으로 총 200 만 BCV 이상의 모기지 및 2 억 개 이상의 BCV를 파는 광산은 곧 온라인이 될 것입니다. BCV 생태계의 지역 사회 지원과 BAC의 가치를위한 중요한 토대를 마련합니다." },
                p5: { cn: '感謝廣大用戶的支持，BCV將進一步加大與各方合作，共同打造更為繁榮的BCV生態。', en: "Thanks to the support of the vast number of users, BCV will further increase cooperation with all parties to jointly create a more prosperous BCV ecosystem.", jp: '多くのユーザーの支持に感謝して、BCV はいっそう各方面と協力して、共に更に繁栄しているBCV 生態を製造します。', ko: '많은 사용자의 지지에 감사드립니다. BCV 는 각측과 협력해 더욱 번영한 BCV 의 생태를 더욱 확대할 것입니다.' },
                p6: { cn: 'BCV基金會', en: 'BCV Foundation', jp: 'BCV 基金', ko: 'BCV 기금회' }
            }
        },
        ...
        product: {
            ...
            list: [
                ...
                },
                {
                    ...
                    title: { en:'Index for Price Change in Digital Asset Market - BCI', cn:'數字貨幣市場價格變化指數 - 幣威指數', jp:'仮想通貨市場の価格変動指数 ― BCV指数', ko:'Index for Price Change in Digital Asset Market - BCI' },
                    content: {
                        ...
                        cn:'币威指数是币威于2018年4月发布的反应数字货币市场全貌的一组指数。币威指数使用客观科学的方法，显示交易性数字货币整体市值变化情况，在计算时不人为指定成分币权数，真实反应数字货币市场全貌。',
                ...
                {
                    icon: 'icon ti-new-window',
                    title: { en:'Passive Quantitative Strategic Product - Quantsuggest', cn:'被動型量化策略產品 — 調倉寶', jp:'受動型量的戦略プロジェクト — 調倉宝―', ko:'Passive Quantitative Strategic Product - Quantsuggest' },
                    content: {
                        en:'Quantsuggest is a passive quantitative strategic product generated by BitCapital Vendor. Its algorithm is based on history transaction records and adjusts the position according to the periodic dynamics of the price, namely buy in at low prices and sell out at high prices. In this way, we manage to realize long',
                        cn:'調倉寶為幣威量化團隊研發的被動性量化策略產品，該演算法以歷史交易數據為基礎，根據價格變動的週期性動態調整倉位，低價買入，高價賣出，實現長期盈利。',
            ...
            list: [
                {
                    ...
                    url: 'http://finance.ifeng.com/a/20180903/16483906_0.shtml',
                    name: { en:'凤凰网财经', cn:'凤凰网财经', jp:'凤凰网财经', ko:'凤凰网财经' },
                    intro: {
                        en:'币威刘志华：区块链应用应兼顾用户安全与体验',
                        cn:'币威刘志华：区块链应用应兼顾用户安全与体验',
                        jp:'币威刘志华：区块链应用应兼顾用户安全与体验',
                        ko:'币威刘志华：区块链应用应兼顾用户安全与体验'
                    }
                },
                {
